	...
	<div class="accordion" id="accordion2">
                  ...
                  <div id="collapseOne" class="accordion-body in collapse" style="height: auto;">
					...
					<?php echo form_open('chat_recording/search_recording'); ?>
	 ...
	 <div class="span9">
		...
		<?php if($page == "chat_recordings2"){?><p><h5>Total Of Row(s) : <?php  if(isset($total_rows)){ echo $total_rows; } ?></h5></p><?php } ?>
		...
		<table class="table table-striped table-hover table-bordered">
			...
			?>
				<tr>
				  <td><?php echo $date; ?></td>
				  <td><?php echo $time; ?></td>
				  <td><?php foreach($get_chat_records as $chat_row){ if($chat_row->threadid == $row->unique_id){
					  if(strlen($chat_row->tmessage) > 10){
						$string = trim(substr($chat_row->tmessage, 0, 50))."<br />";
						echo $string;
					  }else{
						echo $chat_row->tmessage."<br /><br />";
					  }
				  }}
				  ?></td>
				  ...
				  <td style="width:150px;">
					<?php   if($row->status == 1){
						$assign_form_url = site_url('chat_recording/assign_form_agent/'.$row->record_id.'/');
