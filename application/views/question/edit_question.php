...
<!-- Edit question -->
<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" class="modal hide fade" id="edit_question">
    <div class="modal-header"  style="cursor:move">
	   <a href="<?php echo site_url("question/index/$qm_id/$criteria_id"); ?>" class="close">×</a>
      <h3 id="myModalLabel" title="drag me around">Edit Question <i class="icon-move" style="margin-top:10px;"></i></h3>
    </div>
	<?php echo form_open('question/edit_question'); ?>
    ...
    <div class="form-horizontal">
			...
			<label for="input01" class="control-label">Question Title*:</label>
			<div class="controls">
			<input id="title" name="question_title" size="30" type="text"   class="span3" value="<?php echo set_value('question_title',$data_records->question_title); ?>" placeholder="Question Title"  title="Eg: Your Question Title"  />
			</div>
			</div>
			...
			<div class="controls">
			<label class="radio">
			  <input type="radio" name="question_format" id="question_format1" value="4"<?php if($data_records->question_format == '4'){ echo set_checkbox('question_format', '4',TRUE); }else{ echo set_checkbox('question_format', '4'); } ?>>
			  Critical Business
			</label>
			<label class="radio">
			  <input type="radio" name="question_format" id="question_format2" value="5" <?php if($data_records->question_format == '5'){ echo set_checkbox('question_format', '5',TRUE); }else{ echo set_checkbox('question_format', '5'); } ?>>
			  Critical Customer
			</label>
			<label class="radio">
			  <input type="radio" name="question_format" id="question_format3" value="6" <?php if($data_records->question_format == '6'){ echo set_checkbox('question_format', '6',TRUE); }else{ echo set_checkbox('question_format', '6'); } ?>>
			  Non Critical
			</label>
			</div>
			</div>
			...
			<div id="question_na2" class="control-group formSep template">
			<label for="input01" class="control-label">Question With N/A*:</label>
			<div class="controls">
			<label class="checkbox inline">
			  <input type="checkbox" id="inlineCheckbox1" value="1" name="question_na"  <?php if($data_records->question_na == "1"){ echo set_checkbox('question_na', '1',TRUE); }else{ echo set_checkbox('question_na', '0'); } if($data_records->question_format == "3"){ ?>disabled <?php }?>> N / A
			</label>
			</div>
			</div>

			<div  id="question_type2" class=" control-group formSep">
			<label for="input01" class="control-label">Question Type*:</label>
			<div class="controls">
			<label class="radio">
			  <input type="radio" name="question_type" id="question_type1" value="y" <?php if($data_records->question_type == "y"){ ?>checked  <?php } ?> readonly="readonly">
			  Yes / No
			</label>
			<label class="radio">
			  <input type="radio" name="question_type" id="question_type2" value="n" <?php if($data_records->question_type == "n"){ ?> checked <?php } ?> readonly="readonly">
			 Multiple Choice
			</label>
			</div>
			</div>

			<?php if($data_records->question_type == "y"){ ?>
			<div class="control-group formSep">
			<label for="input01" class="control-label">Yes / No Score*:</label>
			<div class="controls">
			<div class="input-prepend">
			  <span class="add-on">Yes Score</span>
			  <input class="span2" name="question_score_y_yes" id="question_score_y_yes" type="text" value="<?php echo set_value('question_score_y_yes',$data_records->question_score_y_yes); ?>"  placeholder="Yes Score" >
			</div>
			<div class="input-prepend">
			  <span class="add-on">No Score</span>
			  <input class="span2" name="question_score_y_no" id="question_score_y_no" type="text" value="<?php echo set_value('question_score_y_no',$data_records->question_score_y_no); ?>"  placeoholder="No Score">
			</div>
			</div>
			</div>
			<?php } ?>
			<?php if($data_records->question_type == "n"){ ?>
			<div  class=" control-group formSep">
			<label for="input01" class="control-label">Multiple Choice*:</label>
			<div class="controls">
			<div class="input-prepend">
			  <span class="add-on">A Score </span>
			  <input class="span2" name="question_score_n_a" id="question_score_n_a" type="text" value="<?php echo set_value('question_score_n_a',$data_records->question_score_n_a); ?>"  placeholder="A Score" >
			</div>
			<div class="input-prepend">
			  <span class="add-on">A Value </span>
			  <input class="span2" name="question_score_n_a_value"  id="question_score_n_a_value" type="text" value="<?php echo set_value('question_score_n_a_value',$data_records->question_score_n_a_value); ?>"  placeholder="A Value">
			</div>
			<br />
			<br />
			...
			<div class="input-prepend">
			  <span class="add-on">B Score </span>
			  <input class="span2" name="question_score_n_b" id="question_score_n_b" type="text" value="<?php echo set_value('question_score_n_b',$data_records->question_score_n_b); ?>"  placeoholder="B Score">
			</div>
			<div class="input-prepend">
			  <span class="add-on">B Value </span>
			  <input class="span2" name="question_score_n_b_value" id="question_score_n_b_value" type="text" value="<?php echo set_value('question_score_n_b_value',$data_records->question_score_n_b_value); ?>"  placeholder="B Value">
			</div>
			<br />
			<br />
			...
			<div class="input-prepend">
			  <span class="add-on">C Score</span>
			  <input class="span2" name="question_score_n_c" id="question_score_n_c" type="text" value="<?php echo set_value('question_score_n_c',$data_records->question_score_n_c); ?>"  placeholder="C Score">
			</div>
			<div class="input-prepend">
			  <span class="add-on">C Value </span>
			  <input class="span2" name="question_score_n_c_value" id="question_score_n_c_value" type="text" value="<?php echo set_value('question_score_n_c_value',$data_records->question_score_n_c_value); ?>"  placeholder="C Value">
			</div>
			<br />
			<br />
			...
			<div class="input-prepend">
			  <span class="add-on">D Score</span>
			  <input class="span2" name="question_score_n_d" id="question_score_n_d" type="text" value="<?php echo set_value('question_score_n_d',$data_records->question_score_n_d); ?>"  placeoholder="D Score">
			</div>
			<div class="input-prepend">
			  <span class="add-on">D Value </span>
			  <input class="span2" name="question_score_n_d_value" id="question_score_n_d_value" type="text" value="<?php echo set_value('question_score_n_d_value',$data_records->question_score_n_d_value); ?>"  placeholder="D Value">
			</div>
			<br />
			<br />
			...
			<div class="input-prepend">
			  <span class="add-on">E Score</span>
			  <input class="span2" name="question_score_n_e" id="question_score_n_e" type="text" value="<?php echo set_value('question_score_n_e',$data_records->question_score_n_e); ?>"  placeholder="E Score">
			</div>
			<div class="input-prepend">
			  <span class="add-on">E Value </span>
			  <input class="span2" name="question_score_n_e_value" id="question_score_n_e_value" type="text" value="<?php echo set_value('question_score_n_e_value',$data_records->question_score_n_e_value); ?>"  placeholder="E Value">
			</div>
			<br />
			<br />
			</div>
    ...
    <div class="modal-footer">
		<input type="hidden" name="question_id" id="question_id"  value="<?php echo set_value('question_id',$data_records->question_id); 	?>" >
		<input type="hidden" name="qm_id" id="qm_id"  value="<?php echo $qm_id; ?>" >
		<input type="hidden" name="criteria_id" id="criteria_id"  value="<?php echo $criteria_id; ?>" >
		<input type="hidden" name="module_index" id="module_index" value="<?php echo site_url("question/index/$qm_id/$criteria_id"); ?>" />
		  <a href="<?php echo site_url("question/index/$qm_id/$criteria_id"); ?>" class="btn">Close</a>
		  <button class="btn btn-primary" type="submit">Save changes</button>
		</form>
    </div>
</div>
...
$(window).load(function(){
	$("#edit_question").modal({backdrop: 'static',keyboard: false}).draggable({
